      ...
      {states === "info" && (
        <>
         ...
         <h1 className={`w-[350px] ${
            index % 2 === 1 ?"text-center sm:text-end" : "text-center sm:text-start"
          ...
          <div className="">
            <p
              ...
              className={`w-[450px] text-base leading-[30px]  text-gray-600 max-w-xs md:max-w-md lg:max-w-lg text-justify ${  index % 2 === 1 ? "text-center sm:text-end" : "text-center sm:text-start"}`}
            >
