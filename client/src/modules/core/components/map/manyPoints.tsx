...
export type Location = {
  lat: number;
  lng: number;
  name?: string; // Optional name for displaying on hover
};
...
interface Params {
  ...
  locations: Location[]; // Array of predefined locations with optional name
}

export const Map = ({ location, setLocation, locations }: Params) => {
  return (
